...
CUE template version 3.0. Use this file to assist in meeting version 3.0 of the CUE template conformance requirements.
...
** Change log: CUE template version 3.0

A change log outlining the changes to the CUE template is available from the docs folder.



** Source code

If you are interested in learning more about how the CUE template reference implementation works, you should obtain a copy of the CUE-template-3.0-src.zip or CUE-template-3.0-src-windows.zip from the Queensland Government WebCentre ( http://ssq.govnet.qld.gov.au/web/ ). See the src folder within these distributions. All code is well commented and extra documentation is provided.
Implementation advice

To assist you in implementing the CUE Standard Template within your agency, please refer to the documentation in the docs folder. More information is available from the Queensland Government WebCentre ( http://ssq.govnet.qld.gov.au/web/ )
...
Information regarding working groups including the Online Advisory Group, CUE Template Development Special Interest Group (and other Special Interest Groups) is available from the Queensland Government Web Centre ( http://ssq.govnet.qld.gov.au/web/ )
